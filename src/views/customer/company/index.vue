          ...
          <el-col :span="14">
            ...
            >
              ...
              <el-form-item label="公司名称" prop="companyName">
                <el-col :span="14">
                  <el-input v-model="customer.companyName" placeholder="请输入公司名称" :maxlength="50" clearable />
                </el-col>
              </el-form-item>
              ...
              <el-form-item label="联系人" prop="contactName">
                <el-col :span="14">
                  <el-input v-model="customer.contactName" placeholder="请输入联系人姓名" :maxlength="20" clearable />
                </el-col>
              </el-form-item>
              <el-form-item label="手机号" prop="contactPhone">
                <el-col :span="14">
                  <el-input v-model="customer.contactPhone" placeholder="请输入联系手机号" :maxlength="11" clearable />
                </el-col>
              </el-form-item>
              <el-form-item label="电子邮箱" prop="email">
                <el-col :span="14">
                  <el-input v-model="customer.email" type="mail" placeholder="请输入电子邮箱" clearable />
                </el-col>
                <el-col :span="8" :offset="2">
                  <el-button :type="canSendCaptcha?'primary':'info'" size="mini" :disabled="!canSendCaptcha" @click="sendCaptcha">{{ captchaText }}</el-button>
                </el-col>
              </el-form-item>
              <el-form-item label="邮箱验证码" prop="mailCode">
                <el-col :span="14">
                  <el-input v-model="customer.mailCode" placeholder="请输入邮箱验证码" :maxlength="4" clearable />
                </el-col>
              </el-form-item>
              <el-form-item label="营业执照号" prop="businessLicenseNo">
                <el-col :span="14">
                  <el-input v-model="customer.businessLicenseNo" placeholder="请输入营业执照编号" :maxlength="18" clearable />
                </el-col>
                <el-col :offset="2" :span="6">
                  <el-upload
                    ...
                    list-type="picture"
                    :limit="2"
                    :file-list="businessLicenseImgFiles"
              ...
              <el-form-item label="身份证姓名" prop="realName">
                <el-col :span="14">
                  <el-input v-model="customer.realName" placeholder="请输入身份证姓名" clearable :maxlength="20" />
                </el-col>
              </el-form-item>
              <el-form-item label="身份证" prop="idCardNo">
                <el-col :span="14">
                  <el-input v-model="customer.idCardNo" placeholder="请输入身份证号" clearable :maxlength="18" />
                </el-col>
                <el-col :offset="2" :span="6">
                  <el-upload
                    :action="fileApi"
              ...
              <el-form-item v-if="customer.isLegalPerson === YN.N" label="授权人" prop="certigier">
                <el-col :span="14">
                  <el-input v-model="customer.certigier" placeholder="请输入授权人" clearable :maxlength="20" />
                </el-col>
                <el-col :offset="2" :span="6">
                  <el-upload
                    :action="fileApi"
                    list-type="picture"
                    :limit="2"
                    :file-list="authorizationImgFiles"
                    :before-upload="initUpload"
                    :headers="requestHeaders"
                    :auto-upload="true"
                    :on-exceed="fileExceed"
  ...
  methods: {
    ...
    fetchCustomer() {
      ...
      GetCustomer().then(res => {
        ...
        if (this.rightCustomer) {
          ...
          if (this.customer.customerType == this.CustomerType.PERSON) {
          ...
          if (customer.idCardImgs) {
            this.idCardImgFiles = customer.idCardDisplayImgs.map((obj, index, arr) => {
              return {
                id: obj.item1,
                url: obj.item2
              }
          ...
          if (customer.businessLicenseImgs) {
            this.businessLicenseImgFiles = customer.businessLicenseDisplayImgs.map((obj, index, arr) => {
              return {
                id: obj.item1,
                url: obj.item2
              }
          ...
          if (customer.authorizationImgs) {
            this.authorizationImgFiles = customer.authorizationDisplayImgs.map((obj, index, arr) => {
              return {
                id: obj.item1,
                url: obj.item2
              }
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          if (this.registerType === 'company') {
            if (!this.customer.businessLicenseImgs || this.customer.businessLicenseImgs.length < 0) {
              this.$message({
                type: 'info',
                message: '请先上传营业执照副本'
              })
    ...
    fileUploadRemove(file, fileList) {
      ...
      fileList.forEach((value, index, array) => {
        that.customer.idCardImgs.push(value.response || value.id)
      })
    },
    fileUploadRemove1(file, fileList) {
      ...
      fileList.forEach((value, index, array) => {
        that.customer.businessLicenseImgs.push(value.response || value.id)
      })
    },
    fileUploadRemove2(file, fileList) {
      ...
      fileList.forEach((value, index, array) => {
        that.customer.authorizationImgs.push(value.response || value.id)
      })
    },
    fileUploadSuccess(response, file, fileList) {
      ...
      this.$message({
        type: 'success',
        message: '已成功上传' + fileList.length + '张营业执照图片'
      })
    },
    fileUploadSuccess1(response, file, fileList) {
      ...
      this.$message({
        type: 'success',
        message: '已成功上传' + fileList.length + '张身份证图片'
      })
    },
    fileUploadSuccess2(response, file, fileList) {
      ...
      this.$message({
        type: 'success',
        message: '已成功上传' + fileList.length + '张授权书图片'
      })
    },
